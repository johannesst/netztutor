...
\fbox{Ausführen}.  In das sich öffnende Fenster tippt  \texttt{cmd}
...
\fbox{Rechtsklick}$\Rightarrow$\fbox{Eigenschaften} folgendes Fenster auf:  
%und noch einer
Hier ist nun auf \fbox{Internetprotokoll (TCP/IP)} und anschließend
auf \fbox{Eigenschaften} zu klicken. Es sollte sich folgendes Fenster
öffnen:
%und noch einer
...
die Richtige den Admins in der \glossar Sprechstunde oder über eine Email an
...
natürlich ist die \glossar Sprechstunde kein Selbstzweck, sondern durchaus
...
ein Programm zur Abwehr von Mißbrauch fährt. Dieses Programm bemerkt
auch enventuelle Angriffe und sperrt dann den entsprechenden
...
nicht zu unterscheiden. Daher nochmal der Hinweis: \textbf{\Large Folgendes nur
  ...
  gerne in der \glossar Sprechstunde weitergeholfen!}.\\\\
