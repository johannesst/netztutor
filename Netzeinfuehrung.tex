...
\normalsize 3. "uberarbeitete Auflage -- Oktober 2011 \vspace{3.3cm}}

\date{\small \sf SchunterNet e.V. \quad Braunschweig\\ \small \sf
  Bienroder Weg 54 \hfill 38108 Braunschweig 
%\hfill  Telefon/Fax: (0531) 2\,35\,14\,59
 \hfill www.schunternet.de}
\author{}
...
Herausgeber: \hspace{0.3cm} \parbox[t]{\textwidth}{SchunterNet e.V.\\ Bienroder Weg 54\\ 38108
  Braunschweig}
\\\\
Autoren: \hspace{1cm} \parbox[t]{\textwidth-15mm}{Ronny Heidenreich, Uwe Gre"shake unter
...
\section{Netzdienste}
\input{dienste/kennung}
\input{dienste/benutzerserver}
\input{dienste/email}
\input{dienste/www}
\input{dienste/usenet}  
\input{dienste/jabber}

\newpage
\section{Sicherheit}
\input{sicherheit/allgemeines}
